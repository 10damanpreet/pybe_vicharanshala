...
app.use('/api', (req, res, next) => {
  if (req.method === 'GET' || req.path.startsWith('/auth') || req.path.startsWith('/sessions')) {
    // Optionally parse user for GET requests or /sessions if token is present
    return optionalAuth(req, res, next);
  }
  // Require valid JWT for POST, PUT, DELETE
